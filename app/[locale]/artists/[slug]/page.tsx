      ...
      <PageShell>
        ...
        <div className="max-w-4xl">
          <div className="grid gap-10 md:grid-cols-[minmax(0,400px)_1fr] md:items-start">
            ...
            <div>
              <header className="max-w-3xl border-b border-pntrsw-deep/20 pb-10">
              ...
              {artist.bio ? (
                <div className="type-body mt-10 max-w-3xl space-y-5 text-base leading-[1.7] text-pntrsw-body/90">
